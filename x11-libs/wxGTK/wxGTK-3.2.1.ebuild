...
WXSUBVERSION=${PV}							# 3.2.1
WXVERSION=${PV}								# 3.2.1
WXRELEASE=${WXVERSION%.*}					# 3.2
WXRELEASE_NODOT=${WXRELEASE//./}			# 32
...
SLOT="${WXRELEASE}"
KEYWORDS="~alpha ~amd64 arm arm64 ~hppa ~ia64 ~mips ppc ppc64 ~riscv sparc ~amd64-linux ~x86-linux"
